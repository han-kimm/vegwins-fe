  ...
  return (
    <>
      ...
      <div
        id="bottomsheet"
        onFocus={sheetFocus}
        className={`${open ? 'bottom-0' : '-bottom-300'} shadow-bt fixed left-0 flex h-max w-full max-w-[50rem] animate-slideDown flex-col rounded-t-md bg-white transition-all max:mx-[calc(50%-25rem)]`}
      >
